...
The implementation details of this feature engineering pipeline are documented in \autoref{sec:app_a} in the Appendix.

\subsection{Preprocessing: The Case for StandardScaler}
We utilized \textbf{StandardScaler} for all numeric inputs. 

As seen in the distribution analysis below, our target variable exhibits varying scales and some outliers, but generally follows a recognizable structure that benefits from centering. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/consumption_violinplot.png}
    \caption{Violin plot showing consumption distribution across hour lags, justifying the use of standardized scaling.}
    \label{fig:consumption_violin}
\end{figure}

StandardScaler centers data at a mean of 0 with a unit standard deviation. This is preferred for gradient stability in Neural Networks and outlier resilience across distance-based methods like SVR.
