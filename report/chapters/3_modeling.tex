...
To move beyond manual heuristic selection, we employed \textbf{Optuna} \cite{optuna2024}, an automated hyperparameter optimization framework. We executed a study consisting of \textbf{100 trials}, utilizing a Tree-structured Parzen Estimator (TPE) to minimize the Mean Absolute Percentage Error (MAPE). 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/tuning_results_2.png}
